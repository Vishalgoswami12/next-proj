        ...
        <div>
            ...
            <h2 style={{color:"#E5DFD9", fontSize:"20px",letterSpacing:"6px",marginLeft:"32px"}}>T A N N  T R I M</h2>
              <div style={{display:"flex",width:"14%" ,justifyContent:"space-evenly",alignItems:"center"}}>
                    ...
                    <Image tylestyle={{color:"#E5DFD9",fontSize:"18px"}} src={require("../assets/user-alt.png")} alt="Search"/>
                    <Image style={{color:"#E5DFD9",fontSize:"18px"}} src={require("../assets/Frame 54.png")} alt="Search"/>
                    <Image style={{color:"#E5DFD9",fontSize:"18px"}} src={require("../assets/Frame 53.png")} alt="Search"/>
                </div>  
            </div>
